...
public class SpringRestClient {
    ...
    public static final String REST_SERVICE_URI = "http://localhost:8080/Securing_RESTful_API_with_OAuth";
    
    public static final String AUTH_SERVER_URI = "http://localhost:8080/SSecuring_RESTful_API_with_OAuth/oauth/token";
    
    public static final String QPM_PASSWORD_GRANT = "?grant_type=password&username=User1&password=abc123";
